            ...
            <div className="relative border-l-2 border-white/10 ml-4 md:ml-6 pl-8 md:pl-10 space-y-12">
                {eduItems.map((item, index) => (
                    <div key={index} className="relative">
                        {/* Timeline Node */}
                        <div className="absolute -left-[41px] md:-left-[49px] top-1.5 w-5 h-5 rounded-full bg-bgMain border-2 border-primary shadow-[0_0_10px_#bb29ff] z-10"></div>
                        ...
                        <div className="text-secondary font-semibold mb-3">{item.uni} <span className="text-primary/80 font-mono text-sm md:hidden ml-2">({item.date})</span></div>
                        ...
                        {item.thesis && (
                            <div className="bg-cardBg/60 border border-white/5 p-5 rounded-xl backdrop-blur-sm relative overflow-hidden group">
                                ...
                                <p className="text-textMuted text-sm mb-4">{item.thesis.title}</p>
